...
function init() {
   ...
   light = new THREE.PointLight(0xFFFF00); //  Luz proveniente de un punto en el espacio, semejante al sol.
    ...
    Cubo.push(cubo(dim, dim, dim, 'red', 'Basic', false)); //Se agrega el cubo 0.

    Cubo.push(cubo(dim, dim, dim, 'green', 'Basic', false)); //Se agrega el cubo 1.

    Cubo.push(cubo(dim, dim, dim, 'yellow', 'Basic', false)); //Se agrega el cubo 2.
